...
export default function Hero() {
  return (
    <section
      className="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen py-20 flex flex-col items-center justify-center gap-8 px-6 lg:px-78 animate-fade-in-up"
      id="home"
    >
      <img
        src={davy}
