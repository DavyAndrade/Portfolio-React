    ...
    <footer className="bg-gray-900 flex flex-col items-center justify-center py-8 px-6 gap-8 max-w-6xl mx-auto">
      <div className="flex flex-col w-full items-center justify-center md:flex-row md:justify-between gap-8">
        ...
        <ul className="flex gap-6">
          <li className="bg-emerald-500 w-10 h-10 rounded-full flex items-center justify-center hover:bg-emerald-600 text-black hover:text-gray-300 transition-colors">
            <a
          ...
          <li className="bg-sky-500 w-10 h-10 rounded-full flex items-center justify-center hover:bg-sky-600 text-black hover:text-gray-300 transition-colors">
            <a
          ...
          <li className="bg-gradient-to-r from-emerald-500 to-sky-500 w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 text-black hover:text-gray-300 transition-colors">
            <a
